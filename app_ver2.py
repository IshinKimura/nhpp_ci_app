...
# ------------------------- Font & Plot Settings -------------------------
# 日本語フォント自動設定（japanize_matplotlib 推奨）
import japanize_matplotlib  # noqa: E402  # type: ignore
plt.rcParams["axes.unicode_minus"] = False  # マイナス符号が文字化けしないように
...
# ------------------------ デフォルト故障データ -------------------------
DEFAULT_FAULT_DATA = (
    "6, 1, 1, 0, 1, 3, 0, 5, 6, 1, 0, 3, 9, 3, 2, 3, 0, 2, 4, 0, "
    "0, 0, 0, 0, 2, 0, 0, 2, 3, 11, 5, 3, 2, 4, 2, 0, 1, 2, 0, 1, "
    "3, 0, 1, 6, 2, 0, 5, 10, 3, 3, 2, 1, 0, 3, 0, 2, 0, 1, 0, 1, 0, 2"
)
